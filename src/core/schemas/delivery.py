...
from src.core.schemas._base import NestedModelSerializerMixin, ReplayableResponseMixin, SalesAgentBaseModel
...
class GetMediaBuyDeliveryRequest(LibraryGetMediaBuyDeliveryRequest):
    ...
    # by adcp SDK 6.6 (spec 3.1.1). No local redeclarations needed.
