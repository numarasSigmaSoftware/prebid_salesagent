...
# NOT AdCPError/normalize_to_adcp_error (which #1697 imports here): this branch's
...
class ContextManager(DatabaseManager):
    ...
    def _send_push_notifications(self, step: WorkflowStep, new_status: str, session: Any) -> None:
        ...
        try:
            ...
            # Sanitized for every operator-facing line below (#1697): scheme://host/path,
            # never credentials or query.
