...
PERSISTED_STATUS_TO_CANONICAL: dict[PersistedMediaBuyStatus, str] = {
    ...
    # The execution claim's two states (see PersistedMediaBuyStatus). A claimed or
    # unconfirmed buy is not confirmed live, so both project exactly like the other
    # pre-serving holds rather than minting a new canonical value.
    PersistedMediaBuyStatus.ACTIVATING: "pending_start",
    PersistedMediaBuyStatus.ACTIVATION_UNKNOWN: "pending_start",
