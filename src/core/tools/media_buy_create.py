...
async def _create_media_buy_impl(
    ...
    if not testing_ctx.dry_run:
        ...
        if push_notification_config:
            ...
            # The value our protocol-callback gate above already validated, so what
            # gets persisted is exactly what was checked (#1697 dropped the former
            # unconditional log here — the guarded one below keeps blank URLs silent).
