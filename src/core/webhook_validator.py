...
class WebhookURLValidator:
    ...
    def validate_webhook_url_registration(cls, url: str) -> tuple[bool, str]:
        ...
        is_valid, error = cls._maybe_allow_localhost(url, is_valid, error, allow_localhost=allow_localhost)
        if is_valid:
            return True, ""
    ...
    def validate_outbound_webhook_url(cls, url: str) -> tuple[bool, str]:
        ...
        return cls._maybe_allow_localhost(url, is_valid, error, allow_localhost=_adcp_testing())
