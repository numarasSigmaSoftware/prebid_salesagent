...
# 18 wired rows; `ENV_ROUTES +=` appends 5 more from `_UC_BUCKET_ROUTES` at
# import time. "How many wired rows are there" therefore has two answers (18 and
# 23), and a floor that does not say which it means is itself an ambiguous
...
EXPECTED_WIRED_ROUTES: frozenset[str] = frozenset(
    {
        ...
        "uc004-create",
        "uc004-poll",
        "uc006-creative-idempotency-v311",
        "uc006-creative-sync",
        "uc010-capabilities",
        "uc010-unwired",
