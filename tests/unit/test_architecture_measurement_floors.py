...
# 16 wired rows; `ENV_ROUTES +=` appends 5 more from `_UC_BUCKET_ROUTES` at
# import time. "How many wired rows are there" therefore has two answers (16 and
# 21), and a floor that does not say which it means is itself an ambiguous
